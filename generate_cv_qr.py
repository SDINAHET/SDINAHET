...
github_url = "https://sdinahet.github.io/SDINAHET/"
...
logo = Image.open("cv_logo.png")  # Ensure the logo file is in the same directory or provide full path
...
qr_code.save("cv_qr_with_logo.png")
print("QR Code with GitHub logo saved as cv_qr_with_logo.png")
